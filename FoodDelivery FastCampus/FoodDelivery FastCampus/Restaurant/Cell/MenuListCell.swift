...
//
//  Created by Mochamad Ikhsan Nurdiansyah on 23/07/24.
//
...
class MenuListCell: UICollectionViewCell {
    ...
    private lazy var menuImageView : UIImageView = {
        ...
        let tapGestureRecognition: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(menuImageViewDidTapped))
        imageView.addGestureRecognizer(tapGestureRecognition)
